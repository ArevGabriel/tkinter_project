...
restaurant = Restaurant("Ayva")
restaurant.add_menu_item('Spaghetti Bolognese', 12.99,'Main Course')
restaurant.add_menu_item('Caesar Salad', 7.99, 'Starter')
restaurant.add_menu_item('Grilled Salmon', 15.99, 'Main Course')
restaurant.add_menu_item('Chocolate Cake', 5.49, 'Dessert')
